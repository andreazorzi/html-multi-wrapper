  ...
  wrap() {
    ...
    if (editor = atom.workspace.getActiveTextEditor()) {
        ...
        for(var i = 0; i < arra.length; i++){
            ...
            newSelection.push([
                [range.start.row + addedRow - 1, range.start.column + 4],
                [range.end.row + addedRow - 1, range.end.column + 4]
            ]);
        ...
        var lastSelection = [
            ...
            [arra[0].end.row + (arra.length * 2), arra[0].end.column + 5]
        ];
